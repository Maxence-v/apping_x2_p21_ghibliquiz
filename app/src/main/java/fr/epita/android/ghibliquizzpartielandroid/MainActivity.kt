...
import fr.epita.android.ghibliquizzpartielandroid.Adaptaters.AnswerListAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    fun initListWithAnswers(answsers: ArrayList<PeopleObject>) {
        ...
        answers.addItemDecoration(DividerItemDecoration(applicationContext, DividerItemDecoration.VERTICAL))

        answers.setHasFixedSize(true)
        answers.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
        answers.adapter = AnswerListAdapter(this, answsers, itemClickListener)
    }
